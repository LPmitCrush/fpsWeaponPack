...
// BigBang Rifle
//=============================================================================
class BigBangRifle extends Weapon
...
var BigBangProjectile ComboTarget;	// used by AI
...
simulated function PostBeginPlay()
{
	...
	//SetOverlayMaterial(OverlayMaterial, 1000000, true);
	Super.PostBeginPlay();
}
...
function SetComboTarget(BigBangProjectile S)
{
...
function float RangedAttackTime()
{
	...
	return FMin(2,0.3 + VSize(B.Enemy.Location - Instigator.Location)/class'BigBangProjectile'.default.Speed);
}
...
function byte BestMode()
{
	...
	if ( B.Skill > 5 )
		MaxDist = 4 * class'BigBangProjectile'.default.Speed;
	else
		MaxDist = 3 * class'BigBangProjectile'.default.Speed;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'fpsWeaponPack.BigBangBeamFire'
     FireModeClass(1)=Class'fpsWeaponPack.BigBangProjFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     InventoryGroup=0
     PickupClass=Class'fpsWeaponPack.BigBangRiflePickup'
     PlayerViewOffset=(X=4.000000,Y=8.000000,Z=-2.000000)
     PlayerViewPivot=(Pitch=-1000)
     BobDamping=1.800000
     AttachmentClass=Class'fpsWeaponPack.BigBangAttachment'
     IconMaterial=Texture'HUDContent.Generic.HUD'
     IconCoords=(X1=250,Y1=110,X2=330,Y2=145)
     ItemName="Big Bang Rifle"
     LightType=LT_Steady
     ...
     DrawScale=0.700000
     Skins(0)=Combiner'fpsWepTex.ShockCombRB'
     Skins(1)=FinalBlend'EpicParticles.Shaders.FireFinal'
