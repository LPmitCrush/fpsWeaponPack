...
simulated function PostBeginPlay()
{
    ...
    {
        SmokeTrail = Spawn(class'fpsWeaponPack.MP5RocketTrailSmoke',self);
        Corona = Spawn(class'fpsWeaponPack.MP5RocketCorona',self);
    }
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
    ...
    {
        Spawn(class'fpsWeaponPack.MP5RocketExplosion',,,HitLocation + HitNormal*20,rotator(HitNormal));
        PC = Level.GetLocalPlayerController();
...
defaultproperties
{
     ...
     MyDamageType=Class'fpsWeaponPack.DamTypeMP5Rocket'
