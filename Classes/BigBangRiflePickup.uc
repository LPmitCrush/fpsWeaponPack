...
// BigBangRiflePickup
//=============================================================================
class BigBangRiflePickup extends UTWeaponPickup;

static function StaticPrecache(LevelInfo L)
{
	if ( class'BigBangRifle'.Default.bUseOldWeaponMesh )
	{
...
defaultproperties
{
     ...
     InventoryType=Class'fpsWeaponPack.BigBangRifle'
     PickupMessage="You got the Big Bang Rifle."
