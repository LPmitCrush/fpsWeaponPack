...
function projectile SpawnProjectile(Vector Start, Rotator Dir)
{
	...
	if ( HoldTime < 0.5)
        {
	   Spawn(class'fpsWeaponPack.MP5Rocket', Owner,, Start, Dir);
	}

 	if ( HoldTime >= 0.5) {
    	g = Spawn(class'fpsWeaponPack.MP5Grenade', Owner,, Start, Dir);
    	if (g != None)
    	{
...
defaultproperties
{
     ...
     AmmoClass=Class'fpsWeaponPack.MP5GrenadeAmmo'
     AmmoPerFire=1
     ShakeRotTime=2.000000
     ShakeOffsetMag=(X=-20.000000)
     ShakeOffsetRate=(X=-1000.000000)
     ShakeOffsetTime=2.000000
     ProjectileClass=Class'fpsWeaponPack.MP5Grenade'
