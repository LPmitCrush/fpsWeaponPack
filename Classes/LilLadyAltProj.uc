...
//	if ( Level.NetMode != NM_DedicatedServer && Level.NetMode != NM_ListenServer)
	...
	{
		AltSmokeTrail = Spawn(class'fpsWeaponPack.AltLilLadyTrail',self);
	}
...
simulated function Explode(vector HitLocation, vector HitNormal)
{
	...
	{
		Spawn(class'fpsWeaponPack.LilLadyAltBlows',,, HitLocation, rotator(HitNormal));
	}
	BlowUp(HitLocation);
...
defaultproperties
{
     DamageTypeHead=Class'fpsWeaponPack.DamTypeHeadShot'
     Speed=15000.000000
     MaxSpeed=16000.000000
     Damage=120.000000
     DamageRadius=10.000000
     MomentumTransfer=100.000000
     MyDamageType=Class'fpsWeaponPack.DamTypeAltLilLady'
