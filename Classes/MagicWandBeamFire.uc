class MagicWandBeamFire extends ShockBeamFire;

#exec AUDIO IMPORT FILE="Snds\fire4.wav" NAME="fire4"
...
defaultproperties
{
     BeamEffectClass=Class'fpsWeaponPack.MagicWandBeamEffect'
     DamageType=Class'XWeapons.DamTypeSuperShockBeam'
     DamageMin=1000
     DamageMax=1000
     Momentum=100000.000000
     FireSound=Sound'fpsWeaponPack.fire4'
     FireRate=0.500000
     AmmoClass=Class'fpsWeaponPack.MagicWandAmmo'
     AmmoPerFire=0
}
