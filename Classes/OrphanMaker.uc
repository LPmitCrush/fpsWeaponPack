...
// Flak Cannon
//=============================================================================
class OrphanMaker extends Weapon
...
defaultproperties
{
     FireModeClass(0)=Class'fpsWeaponPack.OrphanMakerFireA'
     FireModeClass(1)=Class'fpsWeaponPack.OrphanMakerFireB'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     ...
     InventoryGroup=0
     GroupOffset=1
     PickupClass=Class'fpsWeaponPack.OrphanMakerPickup'
     PlayerViewOffset=(X=-7.000000,Y=8.000000)
     PlayerViewPivot=(Yaw=16884,Roll=200)
     BobDamping=1.400000
     AttachmentClass=Class'fpsWeaponPack.OrphanMakerAttachment'
     IconMaterial=Texture'HUDContent.Generic.HUD'
     IconCoords=(X1=169,Y1=172,X2=245,Y2=208)
     ItemName="Orphan Maker"
     LightType=LT_Steady
