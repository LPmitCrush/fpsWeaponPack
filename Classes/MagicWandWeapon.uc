...
defaultproperties
{
     ...
     FireModeClass(0)=Class'fpsWeaponPack.MagicWandBeamFire'
     FireModeClass(1)=Class'fpsWeaponPack.MagicWandAltFire'
     SelectAnim="Pickup"
     PutDownAnim="PutDown"
     SelectSound=Sound'fpsWeaponPack.weaponload'
     ...
     InventoryGroup=4
     PickupClass=Class'fpsWeaponPack.MagicWandPickup'
     PlayerViewOffset=(X=4.000000,Y=8.000000,Z=-2.000000)
     PlayerViewPivot=(Pitch=-1000)
     BobDamping=1.800000
     AttachmentClass=Class'fpsWeaponPack.MagicAttachment'
     ...
     LightPeriod=3
     Mesh=SkeletalMesh'fpsWepAnim.Wand.ShockRifle'
     DrawScale=0.700000
