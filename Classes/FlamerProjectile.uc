...
{
    if ( (FlamerProjectile(Other) == None) && ((Physics == PHYS_Falling) && (Physics == PHYS_None) || (Other != Instigator)) )
    {
        ...
        if ( speed > 200 )
        {
			...
			Spawn(class'fpsWeaponPack.FireExplosionz');
			}
        }
        Destroy();
    }
...
defaultproperties
{
     ...
     MyDamageType=Class'DamTypeFlamer'
     DrawType=DT_None
     Drawscale=0.100000
