...
//#exec AUDIO IMPORT File="Snds\PortalEntry.wav" Name="PortalEntry"
#exec AUDIO IMPORT File="Snds\PortalGrow.wav" Name="PortalGrow"
#exec AUDIO IMPORT File="Snds\PortalShrink.wav" Name="PortalShrink"
//#exec AUDIO IMPORT File="Snds\PortalAmbientSound.wav" Name="PortalAmbientSound"
...
simulated function PostNetBeginPlay()
{
	...
	foreach DynamicActors(Class'pgPortalDecal', pd)
	{
...
simulated function Touch(actor Other)
{
	...
	if (pgPortalProjectile(Other) != none && Other.Instigator != none && Other.Instigator.Controller != none && Owner == Other.Instigator.Controller)
	{
		// Not very well tested ;) the code could do with a cleanup
		ProjEnergy = (pgPortalProjectile(Other).StartingPortalSize - pgPortalProjectile(Other).DefaultPortalSize) * 0.5;
	...
	if (pgDischargeProj(Other) != none && Other.Instigator != none && Other.Instigator.Controller != none && Owner == Other.Instigator.Controller)
	{
		bDischarging = True;
...
defaultproperties
{
     ...
     StaticMesh=StaticMesh'fpsWepMesh.PortalGun.MeshPortal'
