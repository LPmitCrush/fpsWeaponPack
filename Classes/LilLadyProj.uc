...
//	if ( Level.NetMode != NM_DedicatedServer && Level.NetMode != NM_ListenServer)
	...
	{
		SmokeTrail = Spawn(class'fpsWeaponPack.LilLadyTrail',self);
		Corona = Spawn(class'fpsWeaponPack.LilLadyCorona',self);
	}
...
simulated function Explode(vector HitLocation, vector HitNormal) 
{
	...
	{
	    bingo = Spawn(class'fpsWeaponPack.LilLadyBlows',,,HitLocation + HitNormal*16,rotator(HitNormal));
...
defaultproperties
{
     ...
     MyDamageType=Class'fpsWeaponPack.DamTypeLilLady'
