...
// FlakChunk.
//=============================================================================
class OrphanMakerChunk extends Projectile;

var xEmitter Trail;
var xEmitter TrailGlo;
var byte Bounces;
...
simulated function Destroyed()
{
    ...
    if (TrailGlo !=None) TrailGlo.mRegen=False;
	Super.Destroyed();
}
...
simulated function PostBeginPlay()
{
    ...
    if ( Level.NetMode != NM_DedicatedServer )
    {
        ...
        {
            TrailGlo = Spawn(class'DeathTrailGlo',self);
            Trail = Spawn(class'DeathTrail',self);
            TrailGlo.Lifespan = Lifespan;
...
{
    if ( (DeathChunk(Other) == None) && ((Physics == PHYS_Falling) || (Other != Instigator)) )
    {
...
simulated function HitWall( vector HitNormal, actor Wall )
{
    ...
    if (Trail != None) 
    {
        ...
        if (TrailGlo != None) 
    {
        TrailGlo.mRegen=False;
        TrailGlo.SetPhysics(PHYS_None);
        //Trail.mRegenRange[0] = 0.0;//trail.mRegenRange[0] * 0.6;
        //Trail.mRegenRange[1] = 0.0;//trail.mRegenRange[1] * 0.6;
    }
}
...
defaultproperties
{
     ...
     MyDamageType=Class'fpsWeaponPack.DamTypeOrphanMakerChunk'
     DrawType=DT_StaticMesh
     StaticMesh=StaticMesh'fpsWepMesh.Effects.FlakChunk'
