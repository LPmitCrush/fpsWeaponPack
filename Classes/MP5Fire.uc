...
// MP5Fire.
//=============================================================================
class MP5Fire extends InstantFire;

#exec AUDIO IMPORT FILE="Snds\mp5Fire.wav" NAME="mp5Fire"
...
defaultproperties
{
     DamageType=Class'fpsWeaponPack.DamTypeMP5Bullet'
     DamageMin=18
     DamageMax=20
     Momentum=0.000000
     bPawnRapidFireAnim=True
     FireSound=Sound'fpsWeaponPack.mp5Fire'
     FireForce="AssaultRifleFire"
     FireRate=0.166000
     AmmoClass=Class'fpsWeaponPack.MP5Ammo'
     AmmoPerFire=1
